...
@Component({
  ...
  providers: [{provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => NgbRatingComponent), multi: true}]
})
export class NgbRatingComponent implements ControlValueAccessor,
    OnInit, OnChanges {
  ...
  constructor(private config: NgbRatingConfig, private _changeDetectorRef: ChangeDetectorRef) {
    this.max = config.max;
